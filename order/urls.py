...
from order.views import delete_from_cart, update_to_cart, add_to_cart, cart_quantity, check_out, check_quantity
...
urlpatterns = [
    ...
    path('check-quantity', check_quantity, name='check_quantity'),
